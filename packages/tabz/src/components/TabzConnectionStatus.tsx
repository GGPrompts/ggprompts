...
/**
 * TabzConnectionStatus - Visual indicator for TabzChrome REST API connection
 *
 * Features:
 * - Green/red indicator dot (connected/disconnected)
 * - Tooltip with connection details and help text
 * - Click to refresh connection status
 *
 * Data attributes for TabzChrome automation:
