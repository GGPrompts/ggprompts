...
Suggested themes/styles not yet in the collection. Organized by category.

## Historical / Art Movements
- [x] Gothic — cathedral-inspired, pointed arches, dark stone textures, rose windows
- [x] Baroque — ornate, dramatic, gold leaf, deep jewel tones
...
- [x] Cassette Vaporwave
- [x] Cottagecore Dark (Goblincore x Dark Academia)
- [x] Ice / Frost
- [x] Terracotta Warriors
- [x] Paper Marbling (Ebru)
- [x] Soviet Arcade
