(function () {
  ...
  var META = {
    ...
    'neo-void':                 { theme: 'light',    cat: ['digital'] },
    ...
    'kinetic-flux':             { theme: 'light',    cat: ['digital'] },
    'verdant-grove':            { theme: 'light',    cat: ['nature'] },
    'atlas-console':            { theme: 'light',    cat: ['digital'] },
    ...
    'mughal':                   { theme: 'light',    cat: ['cultural', 'luxury'] },
    'marble-gold':              { theme: 'light',    cat: ['luxury', 'material'] },
