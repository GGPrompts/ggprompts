...
import { Card, CardContent, CardHeader, CardTitle, Button, Badge, Tabs, TabsContent, TabsList, TabsTrigger, ScrollArea, Progress, Separator, Avatar, AvatarFallback, AvatarImage } from "@ggprompts/ui"
import {
  LineChart,
  Line,
  AreaChart,
