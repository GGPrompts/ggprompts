...
export const SpaceBackground: React.FC<SpaceBackgroundProps> = ({
  ...
  useEffect(() => {
    ...
    // Theme-aware nebula colors - amber/gold for GGPrompts default
    const nebulae: Nebula[] = [];
    const nebulaColors = [
      { r: 255, g: 200, b: 87 },   // Amber gold
      { r: 255, g: 170, b: 50 },   // Orange gold
      { r: 200, g: 150, b: 100 },  // Warm brown
      { r: 255, g: 220, b: 130 },  // Light gold
    ];
    ...
    const drawStar = (star: Star, offsetX: number, offsetY: number) => {
      ...
      // Glow effect - amber/warm tinted for GGPrompts
      ...
      gradient.addColorStop(0.1, `rgba(255, 240, 200, ${actualBrightness * 0.8})`);
      gradient.addColorStop(0.5, `rgba(255, 220, 150, ${actualBrightness * 0.3})`);
    ...
    const drawShootingStar = (star: ShootingStar) => {
      ...
      tailGradient.addColorStop(0.1, `rgba(255, 240, 200, ${star.opacity * 0.8 * fadeOpacity})`);
      tailGradient.addColorStop(0.5, `rgba(255, 220, 150, ${star.opacity * 0.3 * fadeOpacity})`);
      tailGradient.addColorStop(1, 'rgba(200, 150, 100, 0)');
    ...
    const animate = (timestamp: number) => {
      ...
      // Deep purple-black background for GGPrompts amber theme
